...
import com.cocoamu.cloud.constant.AsyncTaskStatusEnum;
import com.cocoamu.cloud.vo.AsyncTaskInfo;
...
public class AsyncTaskMonitor {
     ...
     * */
    @Around("execution(* com.cocoamu.cloud.service.async.AsyncServiceImpl.*(..))")
