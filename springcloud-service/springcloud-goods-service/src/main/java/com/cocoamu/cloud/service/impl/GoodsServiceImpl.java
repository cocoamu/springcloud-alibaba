...
import com.cocoamu.cloud.service.IGoodsService;
import com.cocoamu.cloud.vo.PageSimpleGoodsInfo;
...
public class GoodsServiceImpl implements IGoodsService {
    ...
    public List<GoodsInfo> getGoodsInfoByTableId(TableId tableId) {
        ...
        List<GoodsEntity> ecommerceGoods = IterableUtils.toList(
                ecommerceGoodsDao.findAllById(ids)
        );

        return ecommerceGoods.stream()
                .map(GoodsEntity::toGoodsInfo).collect(Collectors.toList());
    }
    ...
    public PageSimpleGoodsInfo getSimpleGoodsInfoByPage(int page) {
        ...
        Page<GoodsEntity> orderPage = ecommerceGoodsDao.findAll(pageable);
        ...
        return new PageSimpleGoodsInfo(
                orderPage.getContent().stream()
                        .map(GoodsEntity::toSimple).collect(Collectors.toList()),
                hasMore
        );
    }
