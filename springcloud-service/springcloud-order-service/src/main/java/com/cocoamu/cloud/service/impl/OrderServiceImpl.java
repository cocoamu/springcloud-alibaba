...
import com.cocoamu.cloud.dao.OrderDao;
import com.cocoamu.cloud.entity.OrderEntity;
import com.cocoamu.cloud.feign.AddressClient;
import com.cocoamu.cloud.feign.NotSecuredBalanceClient;
import com.cocoamu.cloud.feign.NotSecuredGoodsClient;
...
import com.cocoamu.cloud.service.IOrderService;
import com.cocoamu.cloud.source.LogisticsSource;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public TableId createOrder(OrderInfo orderInfo) {
        ...
        // 2. 创建订单
        OrderEntity newOrder = orderDao.save(
                new OrderEntity(
    ...
    public PageSimpleOrderDetail getSimpleOrderDetailByPage(int page) {
        ...
        Page<OrderEntity> orderPage = orderDao.findAllByUserId(
    ...
    private List<PageSimpleOrderDetail.SingleOrderItem> assembleSimpleOrderDetail(
            List<OrderEntity> orders, List<SimpleGoodsInfo> goodsInfos,
    ...
    private List<PageSimpleOrderDetail.SingleOrderGoodsItem> buildOrderGoodsItem(
            OrderEntity order, Map<Long, SimpleGoodsInfo> id2GoodsInfo
    ) {
